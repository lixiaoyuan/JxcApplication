...
{
    public partial class XtraReportWage : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportWage()
        {
            InitializeComponent();
        ...
        private void XtraReportOutProduct_DataSourceDemanded(object sender, EventArgs e)
        {
            ...
            this.DataSource = ReportDataManager.Instances.GetWageDatas(Guid.Parse(OrderId.Value.ToString()));
        }
    }
}
