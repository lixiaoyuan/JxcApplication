...
{
    [POCOViewModel]
    public class ReportExpensesViewModel: ViewModelTabItem
    {
        private ReportManager reportManager;
        public bool ShowLoadingPanel { get; set; }
        public virtual DateTime? StartDate { get; set; }
        public virtual DateTime? EndDate { get; set; }
        public ObservableCollection<ExpensesModel> Datas { get; set; }
        ...
        private void LoadingData()
        {
            ...
            {
                var result = reportManager.QueExpenses(StartDate.Value, EndDate.Value);
        ...
        public ReportExpensesViewModel(Guid menuId, string caption) : base(menuId, caption)
        {
        }
    }
}