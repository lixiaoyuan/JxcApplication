...
namespace JxcApplication.ViewModels
{
    ...
    /// </summary>
    [POCOViewModel]
    public class ExpensesInViewModel : ViewModelTabItem
    {
        ...
        private ExpensesInInsertManager expensesInsertManager;
        private ExpensesInUpdateManager expensesUpdateManager;
/*
...
*/
        ...
        {
            IsNewOrder = true;
            expensesInsertManager =ExpensesInInsertManager.Create();
        ...
        private bool SaveProductCor()
        {
            ...
            if (IsNewOrder)
            {
                ...
                result = expensesInsertManager.InsertExpensesInOrder(Expenses, ExpensesDetail);
            }
            else
            {
                return false;
        ...
        public ExpensesInViewModel(Guid menuId, string caption) : base(menuId, caption)
        {
        }
    }
}