...
{
    public class WaitWorkApprovalOrderViewModel : ViewModelTabItem
    {
        private WorkApprovalOrderManager _approvalOrderManager;
        private WorkApprovalOrder _selectedItem;

        public WaitWorkApprovalOrderViewModel(Guid menuId, string caption) : base(menuId, caption)
        {
        }
        ...
        private Task LoadingDataAsync()
        {
            ...
            return Task.Factory.StartNew(() =>
            {
                ...
                var orders = _approvalOrderManager.QueryWaitApprovalOrders(App.GlobalApp.LoginUser.Id, StartDate.Value,
                    EndDate.Value);
