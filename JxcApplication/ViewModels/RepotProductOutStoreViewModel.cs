...
{
    [POCOViewModel]
    public class RepotProductOutStoreViewModel: ViewModelTabItem
    {
        private ReportManager reportManager;
        public bool ShowLoadingPanel { get; set; }
        public virtual DateTime? StartDate { get; set; }
        public virtual DateTime? EndDate { get; set; }
        public ObservableCollection<ProductOutStoreModel> Datas { get; set; }
        ...
        private void LoadingData()
        {
            ...
            {
                var result = reportManager.QueProductOutStore(StartDate.Value, EndDate.Value);
        ...
        public RepotProductOutStoreViewModel(Guid menuId, string caption) : base(menuId, caption)
        {
        }
    }
}