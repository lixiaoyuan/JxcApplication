...
{
    [POCOViewModel]
    public class ReportAccountTransactionRecordViewModel: ViewModelTabItem
    {
        private ReportManager reportManager;
        public bool ShowLoadingPanel { get; set; }
        public virtual DateTime? StartDate { get; set; }
        public virtual DateTime? EndDate { get; set; }
        public ObservableCollection<AccountTransactionRecordModel> Datas { get; set; }
        ...
        private void LoadingData()
        {
            ...
            {
                var result = reportManager.QueAccountTransactionRecord(StartDate.Value, EndDate.Value);
        ...
        public ReportAccountTransactionRecordViewModel(Guid menuId, string caption) : base(menuId, caption)
        {
        }
    }
}